...
class FizzBuzz
  ...
  def fizz_buzz(number)
    return "fizz buzz deluxe" if (((number % 5 == 0 || number.to_s.include?('5')) && (number % 3 == 0 || number.to_s.include?('3')) && (number > 10 && number.to_s.chars.uniq.length == 1)))%2 == 0 else return "fizz buzz fake deluxe"
